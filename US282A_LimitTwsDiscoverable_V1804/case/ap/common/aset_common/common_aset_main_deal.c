...
static void write_application_properties(void)
{
    ...
    if (APP_FUNC_PLAYLINEIN == g_app_info_state.cur_func_id)
    {
    ...
    retry:
    ret_val = aset_write_data(STUB_CMD_ASET_WRITE_APPLICATION_PROPERTIES, p_application_properties, sizeof(application_properties_t));  
