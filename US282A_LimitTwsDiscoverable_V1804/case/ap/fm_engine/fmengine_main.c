#include "App_fmengine.h"
    ...
    support_waves_fm_t g_support_waves_fm;
#endif
...
int fmengine_init(void)
{
    ...
    {
        g_support_waves_fm.pc_tools = 0x01;
    }
    else if (0xff == g_app_info_state_all.stub_pc_tools_type)
    {
        g_support_waves_fm.pc_tools = 0x02;
    }
      g_support_waves_fm.w_input = (uint8) com_get_config_default(SETTING_APP_SUPPORT_WAVES_INPUT_PARAM);  
#endif
