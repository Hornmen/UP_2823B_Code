...
typedef struct
{
    ...
    uint8 dis_reason;//for discon reanson
#endif //#ifdef ENABLE_TRUE_WIRELESS_STEREO		
    uint8 contotws_timer_cnt;  
    uint8  tws_dev_null;
...
extern int com_btmanager_force_unlink(uint8 src_flag) __FAR__;
extern int com_btmanager_clearpairlist(void) __FAR__;
extern int com_btmanager_force_unlink_tws(void) __FAR__;
