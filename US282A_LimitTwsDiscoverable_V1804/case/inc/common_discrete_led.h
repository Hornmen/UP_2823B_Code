...
#define LED_BL_LINK_PORT     LED_PORT_SPECIAL
#define LED_BL_LINK_PIN      (2)                   //up modify 20170414 for LED01 exchange  
#define LED_BL_SYS_PORT     LED_PORT_SPECIAL
#define LED_BL_SYS_PIN      (3)
#else 
#define LED_BL_LINK_PORT     LED_PORT_GPIOA
