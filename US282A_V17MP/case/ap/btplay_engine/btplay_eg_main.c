...
//	#endif
    ...
    {
        g_support_waves_bt_player.pc_tools = 0x01;
    }
    else if (0xff == g_app_info_state_all.stub_pc_tools_type)
    {
        g_support_waves_bt_player.pc_tools = 0x02;
    }
    g_support_waves_bt_player.w_input  =  (uint8) com_get_config_default(SETTING_APP_SUPPORT_WAVES_INPUT_PARAM);
#endif
