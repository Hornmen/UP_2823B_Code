...
#define APP_TIMER_COUNT         (1)
    ...
    support_waves_linein_t g_support_waves_linein;;
#endif
...
int _app_init(void)
{
    ...
    {
        g_support_waves_linein.pc_tools = 0x01;
    }
    else if (0xff == g_app_info_state_all.stub_pc_tools_type)
    {
        g_support_waves_linein.pc_tools = 0x02;
    }
    g_support_waves_linein.w_input =  (uint8) com_get_config_default(SETTING_APP_SUPPORT_WAVES_INPUT_PARAM);
#endif
