...
void dae_param_print(uint8 audiopp_type)
{
    ...
    PRINT_INFO_INT("MDRC_compensation_peak_detect_attack_time",     p_dae_param->MDRC_compensation_peak_detect_attack_time);
    PRINT_INFO_INT("MDRC_compensation_peak_detect_release_time",    p_dae_param->MDRC_compensation_peak_detect_release_time);     
